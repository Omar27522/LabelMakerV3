...
<section id="getting-started">
    ...
    <h3>First Launch</h3>
    <img alt="LabelMakerV3 Software" src="https://raw.githubusercontent.com/Omar27522/LabelMakerV3/refs/heads/main/HTML/LabelMakerV3/media/software/getting_started.jpg" style="width: 35%; float: right;margin-right: 1%;">
    ...
    <p> The first time you launch the application, it may take a few moments to initialize and set up necessary files.
        by going into Settings and pasting the location where the Labels are, or will be, and SAVE.
    </p>
