...
<h2>Label Maker V3</h2><h2 style="display:inline; float:right;"><ul>
  <li><a href="./media/software/welcome.jpg">The welcome screen</a></li>
  <li><a href="./media/software/settings.jpg">The settings screen</a></li>
  <li><a href="./media/software/returns_data_label.jpg">Returns Data</a></li>
  <li><a href="./media/software/create_label_default.jpg">Create Label Default</a></li>
  <li><a href="./media/software/management.jpg">Management Button</a></li>
