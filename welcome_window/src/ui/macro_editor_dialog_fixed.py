...
class MacroEditorDialog(tk.Toplevel):
    ...
    def _create_ui(self):
        ...
        # Create a frame for the sequence editor
        editor_frame = ttk.Frame(details_frame)
        editor_frame.pack(fill=tk.BOTH, expand=True, pady=(5, 10))
        
        # Create a text editor for the sequence
        self.sequence_editor = scrolledtext.ScrolledText(editor_frame, wrap=tk.WORD, width=80, height=20)
